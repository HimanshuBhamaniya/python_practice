...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    """
    first_id,second_id,third_id,*rest = each_wagons_id
    *corrected_list, = third_id,*missing_wagons,*rest,first_id,second_id
...
def add_missing_stops(route,**kwargs):
    ...
    """
    *stations, = kwargs.values()
    stop_dict = {"stops":stations}
    updated_route = {**route,**stop_dict}
...
def fix_wagon_depot(wagons_rows):
    ...
    """
    return [list(tup) for tup in zip(*wagons_rows)]
