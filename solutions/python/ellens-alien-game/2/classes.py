...
def new_aliens_collection(alien_positions):
    """ Create a list of aliens by taking a list of positions.
    parameter: 
        alien_positions (list): These are the starting positions of aliens.
    return (list): It return a list of aliens at postions mentioned in alien_positions list.
