...
def exchangeable_value(budget, exchange_rate, spread:int, denomination:int):
    ...
    """
    spread= spread/100
    new_exchange_rate = exchange_rate+(exchange_rate*spread)
    new_currency = budget/new_exchange_rate
    number_of_bills = new_currency//denomination
